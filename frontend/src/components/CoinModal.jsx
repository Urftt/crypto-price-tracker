  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-4 text-text-muted hover:text-text text-xl cursor-pointer"
        >
          x
        </button>
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="bg-accent/20 text-accent border border-accent/30 rounded px-3 py-1 text-sm hover:bg-accent/30 cursor-pointer"
          >
            Set Alert
          </button>
        </div>
